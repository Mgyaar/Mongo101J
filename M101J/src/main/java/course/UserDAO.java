...
public class UserDAO {
	...
	public boolean addUser(String username, String password, String email) {
		...
		BasicDBObject user = new BasicDBObject("_id", username).append("username",
				username).append("password", passwordHash);
	...
	public DBObject validateLogin(String username, String password) {
		...
		QueryBuilder queryBuilder = QueryBuilder.start("username").is(username);
		user = usersCollection.findOne(queryBuilder.get());
